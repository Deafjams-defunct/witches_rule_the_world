...
def witches_cron():
    ...
    environment = {
        'WITCHES_RULE_CONSUMER_KEY': os.environ['WITCHES_CONSUMER_KEY'],
        'WITCHES_RULE_CONSUMER_SECRET': os.environ['WITCHES_CONSUMER_SECRET'],
        'WITCHES_RULE_OAUTH_TOKEN': os.environ['WITCHES_OAUTH_TOKEN'],
        'WITCHES_RULE_OAUTH_SECRET': os.environ['WITCHES_OAUTH_SECRET']
    }
